...
$instance->setContainer(($this->privates['.service_locator.qEc7vUD'] ?? $this->load('get_ServiceLocator_QEc7vUDService.php'))->withContext('App\\Controller\\API\\ProblemController', $this));
