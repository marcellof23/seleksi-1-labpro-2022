...
include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/security-http/Firewall/ChannelListener.php';
include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/security-http/EntryPoint/AuthenticationEntryPointInterface.php';
include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/security-http/EntryPoint/RetryAuthenticationEntryPoint.php';
