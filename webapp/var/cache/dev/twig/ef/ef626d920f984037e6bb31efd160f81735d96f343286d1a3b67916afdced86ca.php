...
class __TwigTemplate_8a2b48e46afd9f79dd564a1e6aa22f2430534d3032b7ea401608aacb65886c26 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["exception"] ?? null), "message", [], "any", true, true, false, 17)) {
            ...
            echo "                <div class=\"error-details m-4\">
                    <code>";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 19, $this->source); })()), "message", [], "any", false, false, false, 19), "html", null, true);
            echo "</code>
                </div>
                ";
        }
...
";
    ...
    {
        return array (  120 => 22,  114 => 19,  111 => 18,  109 => 17,  104 => 15,  97 => 13,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "@Twig/Exception/error403.html.twig", "/domjudge/webapp/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
